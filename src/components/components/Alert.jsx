...
const Alert = ({ type, text }) => {
  const getAlertStyles = () => {
    switch (type) {
      ...
      case 'warning':
        return 'bg-yellow-100 border-yellow-400 text-yellow-700 dark:bg-yellow-900 dark:border-yellow-600 dark:text-yellow-200';
      default:
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 border px-4 py-3 rounded-lg shadow-lg transition-all duration-300 ${getAlertStyles()}`}>
